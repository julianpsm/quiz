...
//Definición de rutas a comentarios sociados con sus preguntas
...
router.get('/credits/author', authorController.author);

//Definción de ruta hacia las estadísticas
router.get('/quizes/stats',statsController.show);
